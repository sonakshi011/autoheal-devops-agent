...
def main():
    ...
    try:
        ...
        raw_response = client.generate_content_with_retry(
            ...
            response_schema=GeminiDiagnosisOutput.model_json_schema()
        )
        ...
        final_diagnosis = generate_fallback_diagnosis(payload, "Malformed structured output from AI")
    ...
    logger.info(f"Stage: Pipeline complete. Artifacts written: {output_json_path}, {output_md_path}")
